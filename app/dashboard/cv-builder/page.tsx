      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Build a professional CV — auto-includes your courses and certificates from Law LMS.
          </p>
        </div>
        ...
        <div className="space-y-4 rounded-[20px] bg-card p-6 shadow-sm">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Legal Professional & Consultant"
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Legal Research, Contract Drafting, Public Speaking"
            />
          </div>
