...
export const DEFAULT_FOOTER: FooterContent = {
  brandName: "Law LMS",
  brandTagline:
    "Premium Law preparation platform for students in Bangladesh and worldwide. Learn with structured courses, live classes, and verified certificates.",
  ...
  copyrightText: "Law LMS. All rights reserved.",
}
...
export const DEFAULT_HOMEPAGE_SECTIONS: Record<string, PublicHomepageSection> = {
  hero: {
    key: "hero",
    eyebrow: "Professional Law Preparation",
    title: "Master Law with Expert-Led Preparation",
    description:
  ...
  risk_disclaimer: {
    ...
    title: null,
    description:
      "Law scores depend on individual effort and preparation. Content is for educational purposes only. Law LMS does not guarantee specific grades or exam outcomes.",
    items: [],
    ctaPrimary: null,
    ctaSecondary: null,
  ...
  free_learning_hub: {
    ...
    description:
      "Everything you need to start — courses, videos, ebooks, and Law tips at no cost",
    items: [
      {
        icon: "BookOpen",
        title: "Free Course",
        description: "Start learning Law fundamentals at zero cost",
        href: "/courses?free=true",
      },
      {
        icon: "Youtube",
        title: "YouTube Channel",
        description: "Free Law lessons, tips, and speaking practice",
  ...
  pricing: {
    ...
    description:
      "Start with free public webinars, or upgrade to PRO for exclusive Q&A, mock trials, and live coaching sessions.",
    items: [],
  ...
  why_choose: {
    ...
    eyebrow: "Why Law LMS",
    title: "Why Choose Us",
    description: "Everything you need to become a confident, well-prepared Law candidate",
    items: [
      {
        icon: "Video",
        title: "Live Classes",
      ...
      },
      {
        ...
        description: "Apply what you learn with mock trials and graded writing tasks",
      },
    ],
    ctaPrimary: null,
    ctaSecondary: null,
  ...
  final_cta: {
    key: "final_cta",
    eyebrow: null,
    title: "Start Your Law Journey Today",
    description:
      "Join thousands of students preparing for Law with live classes and a thriving study community.",
    items: [],
    ctaPrimary: { label: "Join Course", href: "/courses" },
    ctaSecondary: { label: "View Pricing", href: "/pricing" },
    metadata: null,
  ...
  featured_courses: {
    ...
    title: "Start Your Law Journey",
    description: "Law courses from beginner basics to advanced advanced preparation",
    items: [],
  ...
  latest_insights: {
    ...
    metadata: {
      emptyMessage:
        "New Law tips coming soon. Check back for speaking topics, writing strategies, and study guides.",
    },
  },
  testimonials: {
    key: "testimonials",
...
const DEFAULT_PAGES: Record<string, Omit<PublicSitePage, "updatedAt">> = {
  about: {
    slug: "about",
    title: "About Law LMS",
    description: "Professional Law preparation for students in Bangladesh and worldwide.",
    contentHtml: `<p>Law LMS is a dedicated Law preparation platform helping students achieve their target grades through structured courses, live classes, mock trials, and mentor support.</p>`,
    seoTitle: "About Us — Law LMS",
    seoDescription: "Learn about Law LMS — professional Law preparation platform.",
  },
  terms: {
    slug: "terms",
    title: "Terms & Conditions",
    description: null,
    contentHtml: `<p>Last updated: June 2026</p><h2>Acceptance of Terms</h2><p>By accessing Law LMS, you agree to these terms.</p>`,
    seoTitle: "Terms & Conditions — Law LMS",
    seoDescription: null,
  },
  "privacy-policy": {
    slug: "privacy-policy",
    ...
    seoTitle: "Privacy Policy — Law LMS",
    seoDescription: null,
  },
  "refund-policy": {
    slug: "refund-policy",
    ...
    seoTitle: "Refund Policy — Law LMS",
    seoDescription: null,
  },
  cookies: {
    slug: "cookies",
    ...
    seoTitle: "Cookie Policy — Law LMS",
    seoDescription: null,
  },
}
